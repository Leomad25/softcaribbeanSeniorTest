...
public class MessageBPlusTree {
    ...
    private int binarySearch(DictionaryPair[] dps, int numPairs, long t) {
        ...
        return Arrays.binarySearch(dps, 0, numPairs, new DictionaryPair(t, new MessageModel()), c);
    }
    ...
    public void insert(long key, MessageModel value){
        if (isEmpty()) {
    ...
    public MessageModel search(long key) {
    ...
    public ArrayList<MessageModel> search(long lowerBound, long upperBound) {

        ArrayList<MessageModel> values = new ArrayList<MessageModel>();
    ...
    public class DictionaryPair implements Comparable<DictionaryPair> {
        ...
        public DictionaryPair(long key, MessageModel value) {
            this.key = key;
            this.value = value;
        }
